import React from 'react'
 ...
 export default function page() {
  ...
  <div className="block rotate-scale-up-diag-1 border-2  max-w-6xl h-80 bg-white p-3 flex">
  <div className="">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGVGCBsYnx-heikEJLfcf3_nPL45GT2mR28g&s" alt="" width={500} height={500}/>
  </div>
